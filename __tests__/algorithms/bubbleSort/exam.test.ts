import bblSort from './../../../src/app/learn/algorithms/sort/bubbleSort/exam';

describe('bubbleSort', () => {
  it('should sort an already sorted array', () => {
    const arr = [1, 2, 3, 4, 5];
    expect(bblSort(arr)).toEqual([1, 2, 3, 4, 5]);
  });
  ...
  it('should sort an array with duplicates', () => {
    ...
    expect(bblSort(arr)).toEqual([1, 2, 2, 3, 3, 4]);
  });

  it('should handle an empty array', () => {
    const arr = [];
    expect(bblSort(arr)).toEqual([]);
  });

  it('should handle an array with one element', () => {
    const arr = [1];
    expect(bblSort(arr)).toEqual([1]);
  });

  it('should sort an array with negative numbers', () => {
    const arr = [-2, 4, -5, 1, 5, 0];
    expect(bblSort(arr)).toEqual([-5, -2, 0, 1, 4, 5]);
  });
  ...
  it('should handle a large array', () => {
    ...
    const assertion = bblSort(largeArray);
